...
(function (window) {
  ...
  TodosData.prototype._updateStatusButtons = function () {
    var buttons = document.getElementsByClassName("todos_statusbutton"); // ES6: spread operator
    ...
    for (var i = 0; i < buttons.length; i++) {
      ...
      if (idOfButton === this.idOfStatusButton) {
        buttons[i].setAttribute("class", "todos_statusbutton todos_statusbutton--selected");
      } else {
  ...
  TodosData.prototype._createListItem = function (item) {
    ...
    if (item.done) {
      classesListItem = this.idOfStatusButton === 1 ? "todos__listitem todos__listitem--cleared todos__listitem--hidden" : "todos__listitem todos__listitem--cleared";
      listElement.setAttribute("class", classesListItem);
    } else {
      classesListItem = this.idOfStatusButton === 2 ? "todos__listitem todos__listitem--hidden" : "todos__listitem";
      listElement.setAttribute("class", classesListItem);
    }
  ...
  TodosData.prototype._createAllTodoItems = function (tempTodos) {
    ...
    tempTodos.forEach(function (tempTodo) {
      ...
      _this.todos.push(new ListItem(tempTodo.id, tempTodo.value, tempTodo.done));
    });
    this.numberOfItemsLeft = this.todos.reduce(this._getNumberOfItemsLeft, 0);
  ...
  TodosData.prototype._updateAllListItems = function () {
    var listItems = document.getElementsByClassName("todos__listitem"); // ES6: arrow fn, this operator
    // ES6: spread operator
